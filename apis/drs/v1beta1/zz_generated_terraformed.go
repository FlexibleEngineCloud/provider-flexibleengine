...
func (mg *Job) GetTerraformResourceType() string {
	return "flexibleengine_drs_job"
}

// GetConnectionDetailsMapping for this Job
func (tr *Job) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"destination_db[*].password": "spec.forProvider.destinationDb[*].passwordSecretRef", "source_db[*].password": "spec.forProvider.sourceDb[*].passwordSecretRef"}
}
