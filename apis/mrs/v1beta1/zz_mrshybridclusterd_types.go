...
type MrsHybridClusterDAnalysisCoreNodesObservation struct {
...
type MrsHybridClusterDAnalysisCoreNodesParameters struct {
...
type MrsHybridClusterDAnalysisTaskNodesObservation struct {
	RootVolumeSize *float64 `json:"rootVolumeSize,omitempty" tf:"root_volume_size,omitempty"`

	RootVolumeType *string `json:"rootVolumeType,omitempty" tf:"root_volume_type,omitempty"`
}

type MrsHybridClusterDAnalysisTaskNodesParameters struct {
...
type MrsHybridClusterDComponentsObservation struct {
...
type MrsHybridClusterDComponentsParameters struct {
}

type MrsHybridClusterDMasterNodesObservation struct {
	RootVolumeSize *float64 `json:"rootVolumeSize,omitempty" tf:"root_volume_size,omitempty"`

	RootVolumeType *string `json:"rootVolumeType,omitempty" tf:"root_volume_type,omitempty"`
}

type MrsHybridClusterDMasterNodesParameters struct {
...
type MrsHybridClusterDObservation struct {

	// Specifies the analysis core nodes information.
	// +kubebuilder:validation:Required
	AnalysisCoreNodes []MrsHybridClusterDAnalysisCoreNodesObservation `json:"analysisCoreNodes,omitempty" tf:"analysis_core_nodes,omitempty"`

	// Specifies the analysis task nodes information.
	// +kubebuilder:validation:Optional
	AnalysisTaskNodes []MrsHybridClusterDAnalysisTaskNodesObservation `json:"analysisTaskNodes,omitempty" tf:"analysis_task_nodes,omitempty"`
	...
	Components []MrsHybridClusterDComponentsObservation `json:"components,omitempty" tf:"components,omitempty"`
	...
	// +kubebuilder:validation:Required
	MasterNodes []MrsHybridClusterDMasterNodesObservation `json:"masterNodes,omitempty" tf:"master_nodes,omitempty"`
	...
	// +kubebuilder:validation:Required
	StreamingCoreNodes []MrsHybridClusterDStreamingCoreNodesObservation `json:"streamingCoreNodes,omitempty" tf:"streaming_core_nodes,omitempty"`

	// Specifies the streaming task nodes information.
	// +kubebuilder:validation:Optional
	StreamingTaskNodes []MrsHybridClusterDStreamingTaskNodesObservation `json:"streamingTaskNodes,omitempty" tf:"streaming_task_nodes,omitempty"`
...
type MrsHybridClusterDParameters struct {

	// Specifies the analysis core nodes information.
	// +kubebuilder:validation:Required
	AnalysisCoreNodes []MrsHybridClusterDAnalysisCoreNodesParameters `json:"analysisCoreNodes" tf:"analysis_core_nodes,omitempty"`

	// Specifies the analysis task nodes information.
	// +kubebuilder:validation:Optional
	AnalysisTaskNodes []MrsHybridClusterDAnalysisTaskNodesParameters `json:"analysisTaskNodes,omitempty" tf:"analysis_task_nodes,omitempty"`
	...
	// Specifies the master nodes information.
	// +kubebuilder:validation:Required
	MasterNodes []MrsHybridClusterDMasterNodesParameters `json:"masterNodes" tf:"master_nodes,omitempty"`
	...
	// Specifies the streaming core nodes information.
	// +kubebuilder:validation:Required
	StreamingCoreNodes []MrsHybridClusterDStreamingCoreNodesParameters `json:"streamingCoreNodes" tf:"streaming_core_nodes,omitempty"`

	// Specifies the streaming task nodes information.
	// +kubebuilder:validation:Optional
	StreamingTaskNodes []MrsHybridClusterDStreamingTaskNodesParameters `json:"streamingTaskNodes,omitempty" tf:"streaming_task_nodes,omitempty"`
...
type MrsHybridClusterDStreamingCoreNodesObservation struct {
	RootVolumeSize *float64 `json:"rootVolumeSize,omitempty" tf:"root_volume_size,omitempty"`

	RootVolumeType *string `json:"rootVolumeType,omitempty" tf:"root_volume_type,omitempty"`
}

type MrsHybridClusterDStreamingCoreNodesParameters struct {
...
type MrsHybridClusterDStreamingTaskNodesObservation struct {
	RootVolumeSize *float64 `json:"rootVolumeSize,omitempty" tf:"root_volume_size,omitempty"`

	RootVolumeType *string `json:"rootVolumeType,omitempty" tf:"root_volume_type,omitempty"`
}

type MrsHybridClusterDStreamingTaskNodesParameters struct {
...
// MrsHybridClusterDSpec defines the desired state of MrsHybridClusterD
type MrsHybridClusterDSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     MrsHybridClusterDParameters `json:"forProvider"`
}

// MrsHybridClusterDStatus defines the observed state of MrsHybridClusterD.
type MrsHybridClusterDStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        MrsHybridClusterDObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// MrsHybridClusterD is the Schema for the MrsHybridClusterDs API. ""page_title: "flexibleengine_mrs_hybrid_cluster_v1"
...
type MrsHybridClusterD struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              MrsHybridClusterDSpec   `json:"spec"`
	Status            MrsHybridClusterDStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// MrsHybridClusterDList contains a list of MrsHybridClusterDs
type MrsHybridClusterDList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []MrsHybridClusterD `json:"items"`
}

// Repository type metadata.
var (
	MrsHybridClusterD_Kind             = "MrsHybridClusterD"
	MrsHybridClusterD_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: MrsHybridClusterD_Kind}.String()
	MrsHybridClusterD_KindAPIVersion   = MrsHybridClusterD_Kind + "." + CRDGroupVersion.String()
	MrsHybridClusterD_GroupVersionKind = CRDGroupVersion.WithKind(MrsHybridClusterD_Kind)
)

func init() {
	SchemeBuilder.Register(&MrsHybridClusterD{}, &MrsHybridClusterDList{})
}
