...
import (
	"context"
	v1beta11 "github.com/FlexibleEngineCloud/provider-flexibleengine/apis/kms/v1beta1"
...
func (mg *Instance) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.Volume); i3++ {
		rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
			CurrentValue: reference.FromPtrValue(mg.Spec.ForProvider.Volume[i3].DiskEncryptionID),
			Extract:      reference.ExternalName(),
			Reference:    mg.Spec.ForProvider.Volume[i3].DiskEncryptionIDRef,
			Selector:     mg.Spec.ForProvider.Volume[i3].DiskEncryptionIDSelector,
			To: reference.To{
		...
		if err != nil {
			return errors.Wrap(err, "mg.Spec.ForProvider.Volume[i3].DiskEncryptionID")
		}
		mg.Spec.ForProvider.Volume[i3].DiskEncryptionID = reference.ToPtrValue(rsp.ResolvedValue)
		mg.Spec.ForProvider.Volume[i3].DiskEncryptionIDRef = rsp.ResolvedReference
