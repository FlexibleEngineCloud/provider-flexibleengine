...
//go:generate go run github.com/upbound/upjet/cmd/scraper --prelude-xpath "//text()[contains(., 'subcategory')]" -n ${TERRAFORM_PROVIDER_SOURCE} -r ../.work/${TERRAFORM_PROVIDER_SOURCE}/${TERRAFORM_DOCS_PATH} -o ../config/provider-metadata.yaml
