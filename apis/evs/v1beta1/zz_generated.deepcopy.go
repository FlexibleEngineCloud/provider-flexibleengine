...
func (in *ComputeVolumeAttachList) DeepCopyInto(out *ComputeVolumeAttachList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]ComputeVolumeAttach, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ComputeVolumeAttachList) DeepCopy() *ComputeVolumeAttachList {
	if in == nil {
		return nil
	}
	out := new(ComputeVolumeAttachList)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComputeVolumeAttachObservation) DeepCopyInto(out *ComputeVolumeAttachObservation) {
	*out = *in
	if in.ID != nil {
		in, out := &in.ID, &out.ID
		*out = new(string)
...
func (in *ComputeVolumeAttachObservation) DeepCopy() *ComputeVolumeAttachObservation {
	if in == nil {
		return nil
	}
	out := new(ComputeVolumeAttachObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComputeVolumeAttachParameters) DeepCopyInto(out *ComputeVolumeAttachParameters) {
	*out = *in
	if in.Device != nil {
		in, out := &in.Device, &out.Device
		*out = new(string)
...
func (in *ComputeVolumeAttachParameters) DeepCopy() *ComputeVolumeAttachParameters {
	if in == nil {
		return nil
	}
	out := new(ComputeVolumeAttachParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ComputeVolumeAttachSpec) DeepCopy() *ComputeVolumeAttachSpec {
	if in == nil {
		return nil
	}
	out := new(ComputeVolumeAttachSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComputeVolumeAttachStatus) DeepCopyInto(out *ComputeVolumeAttachStatus) {
	*out = *in
	in.ResourceStatus.DeepCopyInto(&out.ResourceStatus)
	in.AtProvider.DeepCopyInto(&out.AtProvider)
}
...
func (in *ComputeVolumeAttachStatus) DeepCopy() *ComputeVolumeAttachStatus {
	if in == nil {
		return nil
	}
	out := new(ComputeVolumeAttachStatus)
	in.DeepCopyInto(out)
	return out
}
