...
import (
	...
	v1beta1 "github.com/FlexibleEngineCloud/provider-flexibleengine/apis/fgs/v1beta1"
)
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	r := managed.NewReconciler(mgr,
		...
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), o.WorkspaceStore, o.SetupFn, o.Provider.Resources["flexibleengine_fgs_function"],
