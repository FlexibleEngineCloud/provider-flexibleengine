...
import (
	...
	v1beta1 "github.com/FrangipaneTeam/provider-flexibleengine/apis/cts/v1beta1"
)
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	r := managed.NewReconciler(mgr,
		...
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), o.WorkspaceStore, o.SetupFn, o.Provider.Resources["flexibleengine_cts_tracker_v1"],
