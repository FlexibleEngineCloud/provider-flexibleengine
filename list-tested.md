...
|Kind|CRD|Tested|
|---|---|---|
|LoadBalancer|LoadBalancer.elb.flexibleengine.upbound.io/v1beta1|:x:|
|Pool|Pool.elb.flexibleengine.upbound.io/v1beta1|:x:|
|L7Rule|L7Rule.elb.flexibleengine.upbound.io/v1beta1|:x:|
|Monitor|Monitor.elb.flexibleengine.upbound.io/v1beta1|:x:|
|Listener|Listener.elb.flexibleengine.upbound.io/v1beta1|:x:|
|Member|Member.elb.flexibleengine.upbound.io/v1beta1|:x:|
|L7Policy|L7Policy.elb.flexibleengine.upbound.io/v1beta1|:x:|
|Whitelist|Whitelist.elb.flexibleengine.upbound.io/v1beta1|:x:|
...
|Kind|CRD|Tested|
|---|---|---|
|DnatRule|DnatRule.nat.flexibleengine.upbound.io/v1beta1|:heavy_check_mark:|
|Gateway|Gateway.nat.flexibleengine.upbound.io/v1beta1|:heavy_check_mark:|
|SnatRule|SnatRule.nat.flexibleengine.upbound.io/v1beta1|:heavy_check_mark:|
...
|Kind|CRD|Tested|
|---|---|---|
|AccessRule|AccessRule.sfs.flexibleengine.upbound.io/v1beta1|:x:|
|Turbo|Turbo.sfs.flexibleengine.upbound.io/v1beta1|:x:|
|FileSystem|FileSystem.sfs.flexibleengine.upbound.io/v1beta1|:x:|
...
|Kind|CRD|Tested|
|---|---|---|
|Project|Project.iam.flexibleengine.upbound.io/v1beta1|:heavy_check_mark:|
|Provider|Provider.iam.flexibleengine.upbound.io/v1beta1|:heavy_check_mark:|
|Role|Role.iam.flexibleengine.upbound.io/v1beta1|:heavy_check_mark:|
|RoleAssignment|RoleAssignment.iam.flexibleengine.upbound.io/v1beta1|:heavy_check_mark:|
|Group|Group.iam.flexibleengine.upbound.io/v1beta1|:heavy_check_mark:|
|ProviderConversion|ProviderConversion.iam.flexibleengine.upbound.io/v1beta1|:heavy_check_mark:|
|User|User.iam.flexibleengine.upbound.io/v1beta1|:heavy_check_mark:|
|GroupMembership|GroupMembership.iam.flexibleengine.upbound.io/v1beta1|:heavy_check_mark:|
|Agency|Agency.iam.flexibleengine.upbound.io/v1beta1|:x:|
...
|Network|Network.vpc.flexibleengine.upbound.io/v1beta1|:x:|
|SecGroupRule|SecGroupRule.vpc.flexibleengine.upbound.io/v1beta1|:x:|
|Router|Router.vpc.flexibleengine.upbound.io/v1beta1|:x:|
|VPC|VPC.vpc.flexibleengine.upbound.io/v1beta1|:heavy_check_mark:|
|RouterInterface|RouterInterface.vpc.flexibleengine.upbound.io/v1beta1|:x:|
|Route|Route.vpc.flexibleengine.upbound.io/v1beta1|:x:|
|NetworkingSubnet|NetworkingSubnet.vpc.flexibleengine.upbound.io/v1beta1|:x:|
|VPCSubnet|VPCSubnet.vpc.flexibleengine.upbound.io/v1beta1|:heavy_check_mark:|
|VipAssociate|VipAssociate.vpc.flexibleengine.upbound.io/v1beta1|:x:|
|Port|Port.vpc.flexibleengine.upbound.io/v1beta1|:x:|
|Vip|Vip.vpc.flexibleengine.upbound.io/v1beta1|:x:|
|PeeringConnectionAccepter|PeeringConnectionAccepter.vpc.flexibleengine.upbound.io/v1beta1|:x:|
|SecGroup|SecGroup.vpc.flexibleengine.upbound.io/v1beta1|:x:|
|FlowLog|FlowLog.vpc.flexibleengine.upbound.io/v1beta1|:x:|
|PeeringConnection|PeeringConnection.vpc.flexibleengine.upbound.io/v1beta1|:heavy_check_mark:|
...
|Kind|CRD|Tested|
|---|---|---|
|Backup|Backup.csbs.flexibleengine.upbound.io/v1beta1|:x:|
|BackupPolicy|BackupPolicy.csbs.flexibleengine.upbound.io/v1beta1|:x:|
...
|ServerGroup|ServerGroup.ecs.flexibleengine.upbound.io/v1beta1|:heavy_check_mark:|
|KeyPair|KeyPair.ecs.flexibleengine.upbound.io/v1beta1|:heavy_check_mark:|
|FloatingIpAssociate|FloatingIpAssociate.ecs.flexibleengine.upbound.io/v1beta1|:x:|
|Instance|Instance.ecs.flexibleengine.upbound.io/v1beta1|:heavy_check_mark:|
...
|ProviderConfig|ProviderConfig.flexibleengine.upbound.io/v1beta1|:x:|
...
|Kind|CRD|Tested|
|---|---|---|
|EIP|EIP.eip.flexibleengine.upbound.io/v1beta1|:heavy_check_mark:|
|EIPAssociate|EIPAssociate.eip.flexibleengine.upbound.io/v1beta1|:x:|
